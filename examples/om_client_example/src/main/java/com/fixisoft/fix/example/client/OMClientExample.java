...
public final class OMClientExample {
    ...
    public static void main(String[] args)  {
        final String name = OMClientExample.class.getSimpleName();
        final IFixClient fixClient = FixClientFactory.makeClient(makeSimpleClientConfig(name), name,new OMClientIncomingHandler(), new NoopMessageInitializer());
        fixClient.run();
    }
