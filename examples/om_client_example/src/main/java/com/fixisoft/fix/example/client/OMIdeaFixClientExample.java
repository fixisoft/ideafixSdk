...
public final class OMIdeaFixClientExample {
    ...
    public static void main(String[] args)  {
        final String name = OMIdeaFixClientExample.class.getSimpleName();
        final IFixClient fixClient = FixClientFactory.makeClient(makeSimpleClientConfig(name), name, new OMClientIncomingHandler());
        fixClient.run();
    }
