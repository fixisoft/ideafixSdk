...
public final class OMIdeaFixServerExample {
    ...
    public static void main(String[] args) throws IOException {
        final String name1 = OMIdeaFixServerExample.class.getSimpleName()+"_1";
        final String name2 = OMIdeaFixServerExample.class.getSimpleName()+"_2";
        final IFixServer fixServer = makeServer(makeSimpleServerConfig(name1, name2), new OMServerIncomingHandler());
        fixServer.run();
    }
